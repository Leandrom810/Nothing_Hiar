...
<body>
	...
	<?php
			if(isset($GET['inclusion']) && $GET['inclusion'] == 1){ ?>
				...
				<div class="container pagina">
					<div class="row">
						<div class="col">
							...
							<form method="POST" action="scheduler/task_controller.php?action=insert">
								<div class="form-group">
									<label>Descrição da tarefa:</label>
									<input name="Task" type="text" class="form-control" placeholder="A sua tarefa">
								</div>
